...
await fetch(`http://192.168.0.216:3000/api/tasks/${taskId}/activities`, {
  method: 'POST',
...
```typescript
await fetch(`http://192.168.0.216:3000/api/tasks/${taskId}/deliverables`, {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
...
await fetch(`http://192.168.0.216:3000/api/tasks/${taskId}/subagent`, {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
...
1. **Open two browser windows:**
   - Window 1: http://192.168.0.216:3000
   - Window 2: http://192.168.0.216:3000
...
curl -X POST http://192.168.0.216:3000/api/tasks \
